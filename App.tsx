...
const App: React.FC = () => {
  ...
  return (
    <main className="bg-neutral-100 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 font-sans selection:bg-neutral-900 dark:selection:bg-neutral-100 selection:text-neutral-100 dark:selection:text-neutral-950 overflow-x-hidden transition-colors duration-500">
